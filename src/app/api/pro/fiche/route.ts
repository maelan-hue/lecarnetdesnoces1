...
export async function GET() {
  ...
  const pro = await db.pro.findUnique({ where: { id: session.sub }, select: { name:true, tagline:true, bio:true, ambiances:true, styleKeywords:true, city:true, department:true, radiusKm:true, portfolioPhotos:true, profilePhoto:true, category:true, slug:true } });
